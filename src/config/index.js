...
export const productListingFilter = [
  {
    ...
    itemlist: [
      { itemlabel: "Sticker Wallpaper", checked: false, itemcount: 3 },
      { itemlabel: "Wallpaper", checked: false, itemcount: 20 },
      { itemlabel: "Wall Murals", checked: false, itemcount: 6 },
    ],
  },
  {
    itemheader: "Sub Categories",
    itemlist: [
      { itemlabel: "Abstract", checked: false, itemcount: 3 },
      { itemlabel: "Animal", checked: false, itemcount: 20 },
      { itemlabel: "Botanicals", checked: false, itemcount: 6 },
      { itemlabel: "Brick", checked: false, itemcount: 10 },
      { itemlabel: "Classic", checked: false, itemcount: 5 },
      { itemlabel: "Floral", checked: false, itemcount: 6 },
      { itemlabel: "Kids", checked: false, itemcount: 3 },
      { itemlabel: "Marble", checked: false, itemcount: 3 },
      { itemlabel: "Modern", checked: false, itemcount: 20 },
      { itemlabel: "Nature", checked: false, itemcount: 6 },
      { itemlabel: "Royal", checked: false, itemcount: 10 },
      { itemlabel: "Stripes", checked: false, itemcount: 5 },
      { itemlabel: "Texture", checked: false, itemcount: 6 },
      { itemlabel: "Wood", checked: false, itemcount: 3 },
    ],
  },
];
