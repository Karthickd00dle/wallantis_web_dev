...
export const Latestblogs = () => {
    return (
        <div>
        <div>
            <NormalNavigate navigationStyle="latestblogs-head"><div className='mainmenu'><label>Latest Blogs</label></div></NormalNavigate>
        </div>
        <div>
    <div className="division1">
      ...
      <label>How to choose wallpapers for renovating homes....</label><br/>
      <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id in turpis libero odio varius proin lectus. Nulla cras pharetra viverra amet turpis netus. Ipsum sem quis in cursus. Massa vitae, ut eget fermentum ut nunc. </h5>
      </div>
      </div>


      <div>
      <div className="latestblog2">
        </div>
