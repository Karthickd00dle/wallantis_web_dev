...
export const Dealership = () => {
    return (
        <div>
        <div>
            <NormalNavigate navigationStyle="dealership-head"><div className='mainmenu'><label>Dealership</label></div></NormalNavigate>
        </div>
        <div>
        <div className="dealershiphead">
        Why Dealership?
        </div>
      ...
      <div className="dealercontacthead">
      Contact Us
        </div>
        <div className="d-flex dealercontactcards">
        <div className="dealeraddress">
          <span>Address</span>
          <p>115/A, Pycraft Garden Road, Nungambakkam, Chennai - 600 034, Tamil Nadu.</p>
        </div>

        <div className="dealercontactcall">
          <span>Call On</span>
          <p>For any queries call us on</p>
          <small>+91 5684 64865</small><br/>
