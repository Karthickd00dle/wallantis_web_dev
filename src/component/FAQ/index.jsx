...
export default function FAQ() {
  return (
    <div className="accordion-page">
      <div>
        <NormalNavigate navigationStyle="faq-head">
      ...
      <div>
        <Accordion defaultActiveKey="0">
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header className="according-header">
              <h6>Can I get wallpaper customized ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header className="according-header">
              <h6>Can I change colors for my design ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="3">
            <Accordion.Header className="according-header">
              <h6>How does the ordering process works ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="4">
            <Accordion.Header className="according-header">
              <h6>How should I measure my wall ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header className="according-header">
              <h6>How do I clean wallpapers ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header className="according-header">
              <h6>How do I paste my wallpaper ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="7">
            <Accordion.Header className="according-header">
              <h6>Can I follow ypu on social media ?</h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
          ...
          <Accordion.Item eventKey="8">
            <Accordion.Header className="according-header">
              <h6>
                What type of wallpapers works best for my kitchen and Bedrooms ?
              </h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
          ...
          <Accordion.Item eventKey="9">
            <Accordion.Header className="according-header">
              <h6>What are the advantages of using wallpapers ? </h6>
            </Accordion.Header>
            <Accordion.Body className="according-body">
              <p>
                {" "}
